export const Feedbacks = [
    ...
    {
        name: 'Christian Bock',
        description: '´´Mit Oli hatten wir einen Partner, der sehr gut in unser Team passte. Er hat seinen Aufgabenbereich zuverlässig entwickelt, sodass wir mit unserem Projekt gut vorangekommen sind.´´',
        project: 'Join'
